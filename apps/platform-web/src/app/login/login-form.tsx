    ...
    <form action={formAction} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div>
        ...
        <h2 style={{ fontSize: 22, letterSpacing: "-0.01em" }}>
          Connexion à la console plateforme
        </h2>
        <p style={{ fontSize: 13.5, color: "var(--ink-600)", marginTop: 4 }}>
          Saisissez votre NIP d&apos;admin plateforme pour accéder à la console
          Digitalium.
        </p>
      </div>

      <Field label="NIP plateforme" required hint="12 chiffres, sans espaces.">
        <TextInput
          name="nip"
          icon="fingerprint"
          placeholder="196509100099"
