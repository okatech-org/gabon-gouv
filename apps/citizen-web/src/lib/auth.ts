    ...
    genericOAuth({
      config: [
        idn({
          ...
          // Override possible via env vars si on cible un dev local /
          // un autre déploiement IDN. Defaults SDK v0.2 :
          //   issuer:       https://site.identite.ga
          //   discoveryUrl: https://site.identite.ga/api/auth/convex/.well-known/openid-configuration
